...
<head>
    ...
    <title>@yield('title') - t i a s </title>
    ...
    <link rel="stylesheet" href="{{ asset('stylevendors/selectFX/css/cs-skin-elastic.css') }}">
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="http://localhost:8000/home"> <i class="menu-icon fa fa-home"></i>Home </a>
                    </li>
                    <li>
                        <a href="http://localhost:8000/profil"> <i class="menu-icon fa fa-user-circle"></i>Profil </a>
                    </li>
                    <li>
                        <a href="http://localhost:8000/galeri"> <i class="menu-icon fa fa-picture-o"></i>Galeri </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src= "images/wp.jpg">
                        </a>
